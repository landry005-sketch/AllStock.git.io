...
const FeatureCard = ({ icon, title, description, tags, color, bgColor  }: FeatureCardProps) => (
  <div className="bg-white/80 justify-center backdrop-blur-md border border-white/40 p-8 rounded-3xl flex gap-6 items-start hover:-translate-y-2 hover:shadow-2xl hover:shadow-indigo-500/10 hover:border-[#5d5cde]/30 transition-all duration-300 group">
    ...
    <div className="flex flex-col justify-center items-center">
      ...
      <p className="text-slate-600 leading-relaxed mb-4 text-[10px] md:text-base">
        {description}
      </p>
